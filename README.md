...
Made by the Vilijam Cekov (Teaching Assistant) for the course ELE 3915 Excel Programming with Automation for the students of Jonas Moss (Part I) and Adam Lee (Part II) at BI Norwegian Business School. Ocean Depths theme from the `theme-factory` palette collection. Excel function references link to the excellent [ExcelJet](https://exceljet.net/) reference library.
